	...
	<div id="wrapper">
		...
		<div id="contanier">
			...
			<dv id="right">
				...
				<li>You will be awarded by 10 points for having 5 referrals and will be added in the end of game.</li>
				<li></li>
				</ul>
				<a href="home.php"><input id="start_game_btn" class="button_other" type="button" value="START THE GAME"></a>
			</div>
		</div>	
	</div>	
</body>	
